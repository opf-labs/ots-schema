...
public class AnalogDiscFormatRegionTest extends junit.framework.TestCase {

    /** Sample string for testing */
    private final static String discSample =
        "<formatRegion " +
        "    xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" " +
        "    xsi:type=\"analogDiscFormatRegionType\"\n" +
        "    label=\"Label\" " +
        "    ownerRef=\"123\" >\n" +
        " <physicalProperties/> \n" +
        " <speed>" +
    ...
    public void testRead () throws Exception {
        ...
        assertTrue (content instanceof AnalogDiscFormatRegion);
        AnalogDiscFormatRegion a = (AnalogDiscFormatRegion) content;
