...
public class WireDimensionsTest extends junit.framework.TestCase {

    /** Sample string for testing */
    private final static String sample =
        "<dimensions " +
        "    xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" " +
        "    xsi:type=\"wireDimensionsType\">\n" +
        " <diameter unit=\"FEET\">40</diameter> \n" +
    ...
    public void testRead () throws Exception {
        ...
        assertTrue (content instanceof WireDimensions);
        WireDimensions a = (WireDimensions) content;
    ...
    public void testLength () throws Exception {
        WireDimensions wd = new WireDimensions ();
        Measurement m = new Measurement (20.0, "length");
        wd.setLength (m);
        assertTrue (m.equals (wd.getLength()));
    }
}
