 ...
 *
 * @version $Revision: 1.3 $, $Date: 2010/04/20 20:00:33 $
...
public class StAXBuilder {
        ...
        throws XMLStreamException
    {
        ...
        String rootName = r.getName().getLocalPart();
        //doc.setRootElement(new Element("anyxml"));
        ...
        while (true) {
            ...
            case XMLStreamConstants.END_ELEMENT:
            	if(r.getName().getLocalPart().equals(rootName)) {
            		break main_loop;
            	}
            	if(current != null) {
    ...
    /**
     * Method called when option {@link #cfgRemoveIndent} is turned on;
