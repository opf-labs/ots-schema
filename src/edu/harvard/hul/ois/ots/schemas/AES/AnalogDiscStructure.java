...
public class AnalogDiscStructure extends PhysicalStructure {

    private final static String ELEMENTNAME = "analogDiscStructure";
    ...
    public AnalogDiscStructure (XMLStreamReader reader) 
