...
public class OpticalDiscDimensions extends DimensionsSubtype {

    protected final static String TYPENAME = "opticalDiscDimensionsType";
    ...
    protected void dispatch(String localName, XMLStreamReader reader)
        ...
        if (match(reader, this, localName, ELEM_SHAPE, StringElement.class))
            return;
        if (match(reader, this, localName, ELEM_DIAMETER, StringElement.class))
            return;
        if (match(reader, this, localName, ELEM_THICKNESS, StringElement.class))
            return;
